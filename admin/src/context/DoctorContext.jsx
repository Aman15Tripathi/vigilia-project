...
const DoctorContextProvider = (props) => {
    ...
    const getAppointments = async () => {
        try {
            ...
            console.log("URL:", backendUrl + '/api/doctor/appointments');
...
//                 { headers: { dToken } }   // ✅ same header
//             )

//             console.log("API RESPONSE:", data);

//             if (data.success) {
//                 const reversed = [...data.appointments].reverse()  // ✅ FIX
...
//     // ✅ AUTO LOAD appointments when token available
//     useEffect(() => {
//         if (dToken) {
//             getAppointments()
//         }
