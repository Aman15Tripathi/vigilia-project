...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-6 py-14 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-10 text-gray-800 bg-gradient-to-b from-white to-blue-50'>
        ...
        {doctors.slice(0, 10).map((item, index) => (
          ...
          >
            ...
            <div className='relative'>
              <div className='w-full aspect-[3/4] bg-blue-50'>
                <img
